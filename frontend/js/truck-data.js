window.iTruckFleet = [
  {
    ...
    routeFit: 94,
    bio: 'Reliable regional haulier focused on Kenya, Uganda, and port-to-city cargo movements.'
  },
  {
    type: 'Trailer',
    name: 'Scania R450',
    ...
    routeFit: 91,
    bio: 'Long-distance trailer operator for container, industrial, and cross-border freight.'
  },
  {
    type: 'Bus',
    name: 'Yutong ZK6122',
    ...
    routeFit: 72,
    bio: 'Mixed passenger and parcel transport operator serving major Nigerian and West African corridors.'
  },
  {
    type: 'Pickup',
    name: 'Toyota Hilux',
    ...
    routeFit: 88,
    bio: 'Fast light-cargo operator for short regional deliveries and rural access routes.'
  }
];

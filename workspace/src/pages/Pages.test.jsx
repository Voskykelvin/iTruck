...
describe('Page Components Unit & Interaction Tests', () => {
  ...
  test('DocumentsPage slots and actions', async () => {
    ...
    const { rerender } = render(
      <DocumentsPage notify={mockNotify} user={defaultUser} setUser={mockSetUser} />
    );
  ...
  test('ProfilePage signed out and signed in flows', async () => {
    ...
    const { rerender } = render(<ProfilePage notify={mockNotify} route="/app/profile" user={{}} setUser={mockSetUser} signOut={mockSignOut} />);
    ...
    // Render Signed In
    rerender(<ProfilePage notify={mockNotify} route="/app/profile" user={defaultUser} setUser={mockSetUser} signOut={mockSignOut} />);
